...
from core.commandtypes import MPCommands, CommandPair, Command
from encoders.encoder import Encoder
from core.utils import list_index_of_regex
...
class Vvc(Encoder):
    ...
    def match_line(self, line: str, cb: Callbacks):
        ...
        :param cb: Callbacks reference in case error (not implemented but matching super class)
